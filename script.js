...
function fetchObservations() {
  const apiUrl = "https://api.inaturalist.org/v1/observations?quality_grade=research&identifications=any&captive=false&iconic_taxa[]=Plantae&place_id=124854&verifiable=true&popular=true&spam=false&page=" + page + "&per_page=20";
  fetch(apiUrl)
    .then(response => response.json())
    .then(data => {
